...
export const BalanceButton = () => {
    ...
    return useMemo(()=>(
        <div className={`text-sm font-medium  text-prime2 md:text-background1 
            ${(usingBurner && parseInt(data?.formatted)==0)?"md:bg-palered text-white":"md:bg-prime2"}
            ...
            `}>
                ...
                (usingBurner && parseInt(data?.formatted)==0)?"Click Here 2 Get Gas From Faucet Link":
